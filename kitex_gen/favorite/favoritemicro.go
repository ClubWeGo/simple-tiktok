...
func (p *FavoriteListReq) SetToken(val string) {
	p.Token = val
}
...
func (p *FavoriteListReq) Field1DeepEqual(src string) bool {
...
func (p *FavoriteReq) SetToken(val string) {
	p.Token = val
}
...
func (p *FavoriteReq) Field1DeepEqual(src string) bool {
