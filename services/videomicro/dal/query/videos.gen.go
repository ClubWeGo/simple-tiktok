...
func newVideo(db *gorm.DB, opts ...gen.DOOption) video {
	...
	_video.Author_id = field.NewInt64(tableName, "author_id")
	_video.Play_url = field.NewString(tableName, "play_url")
	_video.Cover_url = field.NewString(tableName, "cover_url")
	_video.Favorite_count = field.NewInt64(tableName, "favorite_count")
	_video.Comment_count = field.NewInt64(tableName, "comment_count")
...
type video struct {
	...
	Title          field.String
	Author_id      field.Int64
	Play_url       field.String
	Cover_url      field.String
	Favorite_count field.Int64
	Comment_count  field.Int64
...
func (v *video) updateTableName(table string) *video {
	...
	v.Author_id = field.NewInt64(table, "author_id")
	v.Play_url = field.NewString(table, "play_url")
	v.Cover_url = field.NewString(table, "cover_url")
	v.Favorite_count = field.NewInt64(table, "favorite_count")
	v.Comment_count = field.NewInt64(table, "comment_count")
...
func (v *video) fillFieldMap() {
	...
	v.fieldMap["author_id"] = v.Author_id
	v.fieldMap["play_url"] = v.Play_url
	v.fieldMap["cover_url"] = v.Cover_url
	v.fieldMap["favorite_count"] = v.Favorite_count
	v.fieldMap["comment_count"] = v.Comment_count
}
