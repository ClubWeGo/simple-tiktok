...
func newVideoCount(db *gorm.DB, opts ...gen.DOOption) videoCount {
	...
	_videoCount.ID = field.NewUint(tableName, "id")
	_videoCount.CreatedAt = field.NewTime(tableName, "created_at")
	_videoCount.UpdatedAt = field.NewTime(tableName, "updated_at")
	_videoCount.DeletedAt = field.NewField(tableName, "deleted_at")
	_videoCount.Author_id = field.NewInt64(tableName, "author_id")
	_videoCount.Work_count = field.NewInt64(tableName, "work_count")
...
func (v *videoCount) updateTableName(table string) *videoCount {
	...
	v.Work_count = field.NewInt64(table, "work_count")
...
func (v *videoCount) fillFieldMap() {
	...
	v.fieldMap["work_count"] = v.Work_count
}
